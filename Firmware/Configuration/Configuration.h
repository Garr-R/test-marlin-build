...
#define STRING_CONFIG_H_AUTHOR "(M2 MG-v0.0.2 Marlin-v2.1.2 - Garrett 02/28/2023)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Ki_LIST {   1.1,   1.1 }
    #define DEFAULT_Kd_LIST { 64.51, 64.51 }
  #else
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1200, 1200, 10, 2000 }
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (4*60*4) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 4), (Y_MIN_POS + 10), 20 }
